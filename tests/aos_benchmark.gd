...
func node_benchmark(npc_count: int) -> float:
	...
	reset_vars()
	initialize_npc_structs(npc_count)
	var msec_avg : float = measure_benchmark(npc_count)
	cleanup_npc_structs(npc_count)
	
	return msec_avg

#===============================================================================
func measure_benchmark(npc_count: int) -> float:
	printraw("AoS(", npc_count, " NPCs): ")
...
#===============================================================================
func initialize_npc_structs(npc_count: int):
	for i in range(npc_count):
		var npc := NPCData.new()
		npc.pos = Vector3(0, 0, 0)
		npc.vel = Vector3(1, 0, 0)
		
		npcs.append(npc)

#===============================================================================
func cleanup_npc_structs(npc_count: int):
	npcs.clear()
